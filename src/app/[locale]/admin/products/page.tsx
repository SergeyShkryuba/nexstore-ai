...
// The admin panel is English-only; stock wording comes from the English messages.
const { t: en } = translatorFor('en')
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {stock !== 'in' && (
                          <span className="ml-2 text-xs text-muted-foreground">
                            {stockLabel(product.inventory_count, (k, v) => en(`Stock.${k}`, v))}
                          </span>
                        )}
                        {held.get(product.id) ? (
